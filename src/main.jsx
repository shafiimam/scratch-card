...
async function fetchScratchCardDiscounts() {
  let configInStore = localStorage.getItem("scratchCardConfig");
  if (configInStore === null || configInStore === undefined) {
    // const shop = 'awesome-sauce-123.myshopify.com' || window.location.host;
...
window.onload = function () {
  if (!windowLoaded) {
    ...
    console.log("======= INIT :: SCRATCH-CARD-APP =======");
    let domloadEvent = new Event("DOMContentLoaded");

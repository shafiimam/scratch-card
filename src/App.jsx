...
import { determineWIllWidgetShow, getFontStyle } from './utils/index';
...
function App() {
	...
	console.log('shop sub title', shopConfig);
	...
	const currentSessionCodeIndex = Math.floor(
		Math.random() * discountCodes.length
	);
	...
	useEffect(() => {
      ...
      console.log('width is', containerRef.current.offsetWidth);
